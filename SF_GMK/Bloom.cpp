namespace sfgmk
{
		...
		: m_Size(_Size), m_fSizeDownScale(_SizeDownScale), m_fEffectLevel(_EffectLevel), m_fSaturateLevel(_SaturateLevel), m_BlurOffset(_BlurOffset)
	{
		...
		m_BrightnessShader.loadFromFile("data/sfgmk/shader/saturate.frag", sf::Shader::Fragment);
		m_BlurShader.loadFromFile("data/sfgmk/shader/gaussianBlur.frag", sf::Shader::Fragment);
		m_AddShader.loadFromFile("data/sfgmk/shader/add.frag", sf::Shader::Fragment);
