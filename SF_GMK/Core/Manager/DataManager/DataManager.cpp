namespace sfgmk
{
	...
	bool DataManager::addAnimation(std::string _resName, sfgmk::Animation *_animation)
	{
	...
	{
		sfgmk::Animation *anim = new sfgmk::Animation;
	...
	{
		std::map<std::string, sfgmk::Animation*>::iterator it = m_AnimationMap.find(_resName);
