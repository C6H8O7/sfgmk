namespace sfgmk
{
	TransformationBezier::TransformationBezier(Bezier* _Curb, const float& _Duration, const bool& _DieOnTheEnd) : EntityTransformation(_DieOnTheEnd)
	{
		m_BezierCurb = _Curb;
	...
	Bezier* TransformationBezier::getCurb()
	{
		return m_BezierCurb;
	}
}