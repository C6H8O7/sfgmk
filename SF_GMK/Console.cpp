namespace sfgmk
{
	ConsoleDev::ConsoleDev() : m_bOpacity(false), m_fTimer(0.0f), m_bIsActive(false), m_bIsSeizureActive(false), m_sSeizureBuffer(""), m_sConsoleString(""), m_iConsoleStringLine(0), m_fCpuUsagePercent(0.0f)
	{
		...
		//Rendu
		m_FpsCurbImageOriginal.loadFromFile("data/sfgmk/console/fpsTab.png");
		m_Font[0].loadFromFile("data/sfgmk/console/fontSquare.ttf");
		m_Font[1].loadFromFile("data/sfgmk/console/fontCOMUNICA_TYPE.ttf");
		m_Texture[0].loadFromFile("data/sfgmk/console/background.png");
		...
		//Camera
		m_Texture[1].loadFromFile("data/sfgmk/console/camera.png");
