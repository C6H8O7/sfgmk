...
namespace sfgmk
{
	namespace engine
	{
		class PhysicManager : public SingletonTemplate<PhysicManager>
		{
			...
			bool collisionSphereSphere(SphereCollider* _Collider1, SphereCollider* _Collider2, Entity* _Entity1, Entity* _Entity2);
			bool collisionObbObb(ObbCollider* _Collider1, ObbCollider* _Collider2, Entity* _Entity1, Entity* _Entity2);

			bool collisionSphereObb(SphereCollider* _SphereCollider, ObbCollider* _BoxCollider, Entity* _Entity1, Entity* _Entity2);
		};
	}
}
