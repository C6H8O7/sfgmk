namespace sfgmk
{
	...
	{
		m_BrightnessShader = &DATA_MANAGER->getShader("sfgmk_saturate");
		m_BlurShader = &DATA_MANAGER->getShader("sfgmk_gaussianBlur");
		m_AddShader = &DATA_MANAGER->getShader("sfgmk_add");
