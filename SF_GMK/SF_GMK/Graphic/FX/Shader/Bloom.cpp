namespace sfgmk
{
			...
			: m_Size(_Size), m_fSizeDownScale(_SizeDownScale), m_fEffectLevel(_EffectLevel), m_fSaturateLevel(_SaturateLevel), m_BlurOffset(_BlurOffset)
		{
			...
			m_BrightnessShader.loadFromFile(DATA_PATH + "shader/saturate.frag", sf::Shader::Fragment);
			m_BlurShader.loadFromFile(DATA_PATH + "shader/gaussianBlur.frag", sf::Shader::Fragment);
			m_AddShader.loadFromFile(DATA_PATH + "shader/add.frag", sf::Shader::Fragment);
